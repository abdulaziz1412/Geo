// lib/dict.ts — client-safe bilingual dictionary (NO next/headers import).
// Server code reads the locale via lib/i18n.ts (getLocale); client code reads
// it via readLocaleCookie(). Both get strings from here.
...
// Client-only: read the locale from document.cookie (defaults to ar / SSR-safe).
...
const ar: Dict = {
  ...
  chrome: {
    pricing: "الأسعار", login: "تسجيل الدخول", signup: "إنشاء حساب",
  ...
  login: {
    ...
    alt: "ليس لديك حساب؟", altLink: "إنشاء حساب",
  },
  signup: {
    title: "إنشاء حساب", org: "اسم المؤسسة", email: "البريد الإلكتروني", password: "كلمة المرور",
    submit: "إنشاء الحساب", busy: "جارٍ الإنشاء…", defaultOrg: "مؤسستي",
    orgErr: "أُنشئ الحساب، لكن تعذّر إنشاء المؤسسة: ", confirm: "تحقّق من بريدك لتأكيد الحساب ثم سجّل الدخول.",
    alt: "لديك حساب؟", altLink: "تسجيل الدخول",
  },
  langLabel: "EN",
};
...
const en: Dict = {
  ...
  chrome: {
    pricing: "Pricing", login: "Log in", signup: "Sign up",
  ...
  login: {
    ...
    alt: "Don\u2019t have an account?", altLink: "Sign up",
  },
  signup: {
    title: "Create account", org: "Organization name", email: "Email", password: "Password",
    submit: "Create account", busy: "Creating\u2026", defaultOrg: "My organization",
    orgErr: "Account created, but organization setup failed: ", confirm: "Check your email to confirm your account, then log in.",
    alt: "Have an account?", altLink: "Log in",
  },
  langLabel: "\u0639",
};
